...
function change_zvon() {

	document.getElementById('main_screen').style.display = 'none';
	document.getElementById('screen_zvon').style.display = 'block';
	document.getElementById('screen_objav').style.display = 'none';

}
function change_objav() {

	document.getElementById('main_screen').style.display = 'none';
	document.getElementById('screen_zvon').style.display = 'none';
	document.getElementById('screen_objav').style.display = 'block';
